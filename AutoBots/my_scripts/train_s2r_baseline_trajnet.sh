...
for low_data in 0.05 0.1 0.2 0.3 0.5 0.8 1.0; do
    python train.py \
        --exp-id s2r_baseline_trajnet_$low_data \
        --seed 1 \
        --dataset s2r_baseline \
        --dataset-path ./datasets/trajnet++/processed_6/ \
        ...
        --low_data $low_data\
        --save_step_start 20000\
        --save_step_end 25000\
        --save_every_ckp 10\
        --dataset-path-real ./datasets/trajnet++/processed_6/\
    ...
    # evaluate
    python evaluate_last_ckps.py --dataset-path ./datasets/trajnet++/processed_6/ \
        --models-path /scratch/izar/luan/results/s2r_baseline/Autobot_ego_NScene:-1_regType:None_s2r_baseline_trajnet_${low_data}_s1/ \
        --batch-size 64 --save_step_start 20000 --save_step_end 25000 --output_tag s2r_baseline_trajnet_$low_data
done